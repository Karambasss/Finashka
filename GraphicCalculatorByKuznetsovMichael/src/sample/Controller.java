            ...
            if (choser == 1) {
                ...
                try {
                    ...
                    if (hardChoicer == 1) {
                        ...
                        lbl_control.setText("Ответ: " + Math.ceil(x / y));

                        System.out.println("Ответ: " + Math.ceil(x / y));
                    } else {

                        lbl_control.setText("Ответ: " + Math.ceil(y / x));

                        System.out.println("Ответ: " + Math.ceil(y / x));
                    }
                }
                catch (NumberFormatException e){
                    System.out.println("Вы ввели в поле для целого числа либо строку, либо дробное число" + '\n' +
                ...
                try {
                    ...
                    if (hardChoicer == 1) {
                        ...
                        lbl_control.setText("Ответ: " + String.valueOf(Math.ceil(x / y)));
